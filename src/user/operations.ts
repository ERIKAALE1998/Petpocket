...
// --- NUEVA FUNCIÓN AÑADIDA PARA PODER SER VETERINARIA ---
export const updateUserRole = async (args: { role: string }, context: any) => {
  if (!context.user) {
    throw new HttpError(401, "Debes iniciar sesión para cambiar tu rol");
  }
